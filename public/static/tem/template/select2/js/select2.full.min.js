        ...
        return e && e.requirejs || (e ? n = e : e = {}, m = {}, v = {}, y = {}, _ = {}, r = Object.prototype.hasOwnProperty, a = [].slice, w = /\.js$/, f = function (e, t) {
            ...
            return a.Extend(n, e), n.prototype.render = function () {
                ...
                n.__super__.bind.apply(this, arguments), this.$selection.on("click", function (e) {
                    ...
                    if (!i.options.get("disabled")) {
                        var t = r(this).parent(), n = a.GetData(t[0], "data");
            ...
            return e.prototype.render = function (e) {
                ...
                this.$selection.on("input.searchcheck", ".select2-search--inline", function (e) {
                    ...
                    if (o && "input" === e.type) i.$selection.off("input.search input.searchcheck"); else {
                        var t = e.which;
            ...
            return n.prototype.apply = function (t) {
                if (null == (t = f.extend(!0, {}, this.defaults, t)).dataAdapter) {
                    if (null != t.ajax ? t.dataAdapter = C : null != t.data ? t.dataAdapter = D : t.dataAdapter = S, 0 < t.minimumInputLength && (t.dataAdapter = A.Decorate(t.dataAdapter, q)), 0 < t.maximumInputLength && (t.dataAdapter = A.Decorate(t.dataAdapter, T)), 0 < t.maximumSelectionLength && (t.dataAdapter = A.Decorate(t.dataAdapter, j)), t.tags && (t.dataAdapter = A.Decorate(t.dataAdapter, E)), null == t.tokenSeparators && null == t.tokenizer || (t.dataAdapter = A.Decorate(t.dataAdapter, O)), null != t.query) {
                ...
                if (null == t.resultsAdapter && (t.resultsAdapter = m, null != t.ajax && (t.resultsAdapter = A.Decorate(t.resultsAdapter, I)), null != t.placeholder && (t.resultsAdapter = A.Decorate(t.resultsAdapter, P)), t.selectOnClose && (t.resultsAdapter = A.Decorate(t.resultsAdapter, U))), null == t.dropdownAdapter) {
                    if (t.multiple) t.dropdownAdapter = L; else {
                        var i = A.Decorate(L, k);
                        t.dropdownAdapter = i
                    }
                    if (0 !== t.minimumResultsForSearch && (t.dropdownAdapter = A.Decorate(t.dropdownAdapter, R)), t.closeOnSelect && (t.dropdownAdapter = A.Decorate(t.dropdownAdapter, z)), null != t.dropdownCssClass || null != t.dropdownCss || null != t.adaptDropdownCssClass) {
                ...
                if (null == t.selectionAdapter) {
                    if (t.multiple ? t.selectionAdapter = y : t.selectionAdapter = v, null != t.placeholder && (t.selectionAdapter = A.Decorate(t.selectionAdapter, _)), t.allowClear && (t.selectionAdapter = A.Decorate(t.selectionAdapter, w)), t.multiple && (t.selectionAdapter = A.Decorate(t.selectionAdapter, $)), null != t.containerCssClass || null != t.containerCss || null != t.adaptContainerCssClass) {

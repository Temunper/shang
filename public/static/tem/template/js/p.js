...
function onProvinceChange(proid, deleid, celeid, func) {
    $('#' + celeid).empty();
    $('#' + celeid).append('<option value="0">地/州</option>');
    $('#' + deleid).empty();
    $('#' + deleid).append('<option value="0">市</option>');
    var cityele = document.getElementById(deleid);
...
function getNum(proid, cityid, countryid) {
